...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ url('assets/theme/fonts/icomoon/style.css') }}">
    ...
    <link rel="stylesheet" href="{{ url('assets/theme/css/jquery-ui.css') }}">
    ...
    <div class="site-mobile-menu">
      <div class="site-mobile-menu-header">
        <div class="site-mobile-menu-logo">
          <a href="#"><img src="{{ url('assets/theme/images/logo.png') }}" alt="Image"></a>
        </div>
        ...
        <div class="row">
                  ...
                  <li class="mb-3">
                    <a href="#" class="d-flex">
                      <figure class="image mr-4">
                        <img src="{{ url('assets/theme/images/img_1.jpg') }}" alt="" class="img-fluid">
                      </figure>
                      <div class="text">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            <div class="mb-5">
              ...
              <div class="block-16">
                <figure>
                  <img src="{{ url('assets/theme/images/img_1.jpg') }}" alt="Image placeholder" class="img-fluid rounded">
  ...
  <script src="{{ url('assets/theme/js/jquery-3.3.1.min.js') }}"></script>
  <script src="{{ url('assets/theme/js/jquery-migrate-3.0.1.min.js') }}"></script>
  <script src="{{ url('assets/theme/js/jquery-ui.js') }}"></script>
  ...
  <script src="{{ url('assets/theme/js/jquery.stellar.min.js') }}"></script>
  <script src="{{ url('assets/theme/js/jquery.countdown.min.js') }}"></script>
  <script src="{{ url('assets/theme/js/jquery.magnific-popup.min.js') }}"></script>
  <script src="{{ url('assets/theme/js/aos.js') }}"></script>

  <script src="{{ url('assets/theme/js/main.js') }}"></script>
